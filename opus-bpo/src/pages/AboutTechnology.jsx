...
const AutomationEcosystem = () => {
  ...
  return <section className="section-divider relative bg-[linear-gradient(135deg,#e5f4ff_0%,#edf7ff_28%,#fff8d8_62%,#ffe8e5_100%)]"><div className="pointer-events-none absolute inset-0 overflow-hidden"><div className="absolute -right-32 top-[8%] h-[34rem] w-[34rem] rounded-full bg-blue-300/20 blur-3xl"/><div className="absolute -left-32 top-[42%] h-[30rem] w-[30rem] rounded-full bg-yellow-300/20 blur-3xl"/><div className="absolute -right-24 bottom-[4%] h-[32rem] w-[32rem] rounded-full bg-red-300/20 blur-3xl"/></div><div className="relative mx-auto max-w-7xl px-6 py-20"><div className="mx-auto max-w-4xl text-center"><p className="text-sm font-semibold uppercase tracking-[.22em] text-brand-blue">Automation in Action</p><h2 className="mt-4 font-heading text-3xl font-semibold text-brand-slate md:text-4xl">A scroll-driven view of the connected revenue cycle.</h2></div>
