...
export const services = [
  ...
  },
  {
    ...
    description:
      "Pre-visit insurance checks that reduce denials and improve patient financial clarity.",
    image: "/eligibility-verification-17.png",
    points: [
      "Coverage and benefits validation ahead of visits.",
      "Authorization and referral checks orchestrated by our analysts.",
      "Patient financial clarity workflows with proactive outreach.",
    ],
  },
  {
  ...
  },
  {
    ...
    description:
      "Clean-claim submission workflows with payer-specific edits and clearinghouse coordination.",
    image: "/claim-submission-13.png",
    points: [
      "Pre-submission edit scrubs tuned to payer rules.",
      "Clearinghouse coordination with real-time status visibility.",
      "Receipt tracking until every batch reaches settlement.",
    ],
  },
  {
    title: "Payment Posting",
    description:
      "Timely, balanced posting for EOBs, ERAs, and secondary claims to protect cash flow.",
    image: "/payment-posting-20.jpg",
    points: [
      "ERA/EOB posting workflows with exception routing.",
      "Balanced posting across primary and secondary claims.",
      "Discrepancy handling tied to automated reconciliation alerts.",
    ],
  },
  {
    title: "AR Follow-ups",
    ...
    points: [
      ...
      "Appeals coordination and documentation built into each case.",
    ],
  },
  {
    title: "Patient Invoice Management & Self-Pay Revenue Recovery",
    description:
      "Effective patient statements and self-pay collections to improve cash flow and payment consistency.",
    image: "/patient-invoice-19.jpg",
    points: [
...
export const trustIndicators = [
  {
    title: "HIPAA-Ready Delivery",
    description:
      "Privacy-first workflows and secure data handling practices aligned to healthcare compliance expectations.",
  },
  {
    title: "Accuracy Discipline",
    description:
      "Layered QA, claim scrub rules, and variance reporting to reduce avoidable denials.",
  },
  {
